...
export const products: Product[] = [
  {
    ...
    rating: 4.9,
    details:
      "This premium leather recliner features top-grain leather upholstery, power reclining mechanism, USB charging port, and built-in cup holders. The adjustable headrest and lumbar support ensure maximum comfort for extended periods.",
  ...
  },
  {
    ...
    rating: 4.8,
    details:
      "This versatile sofa bed transforms from a comfortable sofa to a full-size bed in seconds. The hidden storage compartment provides additional space for blankets, pillows, or other items.",
    dimensions: '84"W x 38"D x 34"H (sofa), 84"W x 76"D x 16"H (bed)',
    materials: "Fabric upholstery, solid wood frame, high-density foam",
    features: [
      "Easy pull-out mechanism",
      "Hidden storage compartment",
      "Full-size bed when expanded",
      "Comfortable seating when folded",
      "Sturdy construction",
  ...
  },
  {
    ...
    rating: 4.7,
    details:
      "This elegant queen-size platform bed features a modern design with a wooden headboard and sturdy construction. The low-profile design creates a clean, contemporary look in any bedroom.",
    dimensions: '63"W x 83"D x 14"H',
    materials: "Solid pine wood, engineered wood, metal hardware",
    features: [
      "Modern design",
      "Wooden headboard",
  ...
  },
  {
    ...
    rating: 4.8,
    details:
      "Experience ultimate comfort with this queen-size memory foam mattress. The cooling gel technology helps regulate temperature while you sleep, and the memory foam contours to your body for optimal support.",
    dimensions: '60"W x 80"D x 10"H',
    materials: "Memory foam, cooling gel, hypoallergenic cover",
    features: [
  ...
  },
  {
    ...
    rating: 4.6,
    details:
      "This handcrafted wooden nightstand features a rustic design with two spacious drawers for storage. The solid wood construction ensures durability and longevity.",
    dimensions: '18"W x 16"D x 24"H',
    materials: "Solid pine wood, metal hardware",
    features: [
      "Handcrafted design",
  ...
  },
  {
    ...
    rating: 4.7,
    details:
      "This elegant glass coffee table features a tempered glass top with chrome legs. The modern design adds a touch of sophistication to any living room.",
    dimensions: '48"W x 24"D x 18"H',
    materials: "Tempered glass, chrome metal",
    features: [
      "Tempered glass top",
      "Chrome legs",
      "Modern design",
  ...
  },
  {
    ...
    rating: 4.8,
    details:
      "This elegant velvet accent chair features a luxurious velvet upholstery with gold-finished legs. The comfortable design makes it perfect for reading corners or as a statement piece in your living room.",
    dimensions: '28"W x 32"D x 33"H',
    materials: "Velvet upholstery, solid wood frame, gold-finished metal legs",
    features: [
  ...
  },
  {
    ...
    rating: 4.5,
    details:
      "This 3-piece modern abstract wall art set adds a touch of sophistication to any room. The high-quality canvas prints feature vibrant colors and contemporary designs.",
    dimensions: '3 pieces: 24"W x 36"H each',
  ...
  },
  {
    ...
    rating: 4.7,
    details:
      "This modern bookshelf features five open shelves and a cabinet with doors. The versatile design provides ample storage space for books, decorative items, and more.",
  ...
  },
  {
    ...
    rating: 4.6,
    details:
      "This set of 2 bar stools features adjustable height and cushioned seats for comfort. The modern design adds a touch of sophistication to your kitchen or bar area.",
    dimensions: '18"W x 18"D x 30"-36"H (adjustable)',
    materials: "Metal frame, cushioned seat, faux leather upholstery",
    features: [
      "Set of 2 stools",
      "Adjustable height",
      "Cushioned seats",
